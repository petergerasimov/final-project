...
public class PauseMenu : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        Rect continueRect = new Rect(startX, startY, buttonWidth, buttonHeight);
        Rect exitRect = new Rect(startX, startY + buttonHeight + spacing, buttonWidth, buttonHeight);

        DrawMenuButton(continueRect, "CONTINUE", Resume);
